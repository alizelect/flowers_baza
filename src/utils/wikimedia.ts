...
const IMAGE_QUERY_MAP: Array<{ keys: string[]; query: string }> = [
...
function makeUnsplashUrl(query: string): string {
...
export async function fetchWikimediaImage(query: string): Promise<string> {
